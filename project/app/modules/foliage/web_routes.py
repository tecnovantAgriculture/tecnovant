"""📃 Rutas web del módulo Foliage (gestión de fincas/lotes)
...
Este módulo usa principalmente @login_required, con algunas excepciones @jwt_required()
para endpoints específicos que requieren validación JWT explícita.
"""
...
def nutrientes():
    ...
    context = {
        ...
        "description": "Administre nutrientes y sus unidades.",
...
def amd_farms():
    ...
    context = {
        ...
        "description": "Administre fincas agrícolas y su relación con clientes.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_lots(filter_value=None):
    ...
    context = {
        ...
        "description": "Administre lotes y su relación con fincas.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_crops():
    ...
    context = {
        ...
        "description": "Administre cultivos y sus variedades.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_lot_crops():
    ...
    context = {
        ...
        "description": "Administre la relación entre lotes y cultivos.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_objectives():
    ...
    context = {
        ...
        "description": "Administre objetivos de cultivo y sus metas.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_products():
    ...
    context = {
        ...
        "description": "Administre productos y sus contribuciones nutricionales.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_product_contributions():
    ...
    context = {
        ...
        "description": "Administre contribuciones de productos y su relación con nutrientes.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_product_prices():
    ...
    context = {
        ...
        "description": "Administre precios de productos y su historial.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_common_analyses():
    ...
    context = {
        ...
        "description": "Administre análisis comunes y sus resultados.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_leaf_analyses():
    ...
    context = {
        ...
        "description": "Administre análisis foliares y sus valores nutricionales.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_soil_analyses():
    ...
    context = {
        ...
        "description": "Administre análisis de suelos y sus propiedades.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_nutrient_applications():
    ...
    context = {
        ...
        "description": "Administre aplicaciones de nutrientes y su relación con lotes.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
...
def amd_productions():
    ...
    context = {
        ...
        "description": "Administre producciones agrícolas y su rendimiento.",
        "author": "Johnny De Castro",
        "site_title": "Panel de Control",
        "data_menu": get_dashboard_menu(),
    }
